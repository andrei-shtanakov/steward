...
- [ ] `checksum.sh`, PIN и watch дрейфа — при первом потребителе кита @owner:github:andrei-shtanakov @id:review-kit-vendoring
  ...
  spec-runner. `@id:review-kit-checksum-bootstrap` решён честным доводом в
  шапке скрипта: сверка себя собой — не защита; вторая гарантия —
  upstream-drift watch и ревью PR ре-вендора.
