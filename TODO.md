...
- [ ] `GC-ARCH-*` + узел `architecture` — схема intended-graph/v1 согласована (prograph#22, 2026-08-03), первый манифест — `workstreams/WS-005-gate-verdicts/spec/intended-graph.yaml`; ждём работающий CLI @owner:andrei @trigger:"prograph conformance реализован" @id:behaviour-arch-gates
