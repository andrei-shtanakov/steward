...
- [ ] Дедуп ревью по снимку диффа — вердикт не перегоняется на байт-идентичном входе @owner:github:andrei-shtanakov @id:review-dedup-diff-hash
  ...
  пути same-head-наследования); @blocked_by снят — ожидание доставлено.
  Остаток: обкатка на живых PR и замер экономии (за steward) — доля
  унаследованных вердиктов против платных прогонов, по маркерам
  `fp=` в опубликованных ревью.
