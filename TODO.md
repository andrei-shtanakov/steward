...
- [ ] Измеримый eval: 10–20 прошлых PR (с дефектами, чистые, крупные), метрики @owner:github:andrei-shtanakov @id:review-kit-eval-harness
  ...
  **Разметка закрыта 2026-09-18 — корпус готов к живому прогону.** Одиннадцать
  gold-кейсов (draft: 0), двенадцать дефектов, одна запись `non_defects`:
  шесть исходных черновиков адъюдицированы, добор — steward#130, #151, #162,
  #168 и крупный #86. Из четырёх кандидатов истории подтверждены три (#155-1, #157-1,
  ...
  надгробием. Блокирующих gold-дефектов два (#130-1 и #162-1, оба major,
  оба в кейсах с `blocking_complete`) — знаменатель `blocking_recall`
  впервые непуст, и это пинует тест `test_repo_corpus_is_valid_and_registered`.
...
- [ ] Спека §13 заводит #155 двумя кейсами при уникальном `case_id` — пара непредставима @owner:github:andrei-shtanakov @id:review-eval-spec-starting-corpus-duplicate-case
      ...
      Лечится не сверкой, а решением: стартовый корпус УЖЕ собран (11 кейсов,
