...
CI-ревью экономно и само: PR в драфте не ревьюируется (чек `report` красный с
причиной «ревью отложено» — это не находка), полный прогон запускают снятие
драфта или лейбл `codex-review` на драфте. Лейбл действует со следующего
пуша: само событие навешивания прогон не запускает намеренно — иначе любой
посторонний лейбл пережигал бы прогон на неизменном SHA.
